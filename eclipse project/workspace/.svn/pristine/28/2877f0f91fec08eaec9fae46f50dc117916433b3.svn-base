...
public class FarruscoPackageImpl extends EPackageImpl implements FarruscoPackage
{
  ...
  public void initializePackageContents()
  {
    ...
    initEAttribute(getDistancia_Distancia(), ecorePackage.getEInt(), "distancia", "300", 0, 1, Distancia.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getDistancia_Menor_Maior(), this.getTipoDistancia(), "Menor_Maior", "Maior", 0, 1, Distancia.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEAttribute(getEspera_Nome(), ecorePackage.getEString(), "Nome", "Tempo", 0, 1, Espera.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getEspera_Tempo(), ecorePackage.getEInt(), "Tempo", "1", 0, 1, Espera.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
