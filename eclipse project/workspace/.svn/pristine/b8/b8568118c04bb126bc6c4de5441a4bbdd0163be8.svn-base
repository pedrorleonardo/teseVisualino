...
import farrusco.diagram.edit.policies.ParaleloItemSemanticEditPolicy;
import farrusco.diagram.providers.FarruscoElementTypes;

/**
 * @generated
 */
public class ParaleloEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public ParaleloEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new ParaleloItemSemanticEditPolicy());
	...
	protected IFigure createNodeShape() {
		return primaryShape = new figuresPlan.figures.ParaleloFigure();
	}

	/**
	 * @generated
	 */
	public figuresPlan.figures.ParaleloFigure getPrimaryShape() {
		return (figuresPlan.figures.ParaleloFigure) primaryShape;
	}
