...
import farrusco.diagram.edit.policies.PrioridadeItemSemanticEditPolicy;
import farrusco.diagram.providers.FarruscoElementTypes;

/**
 * @generated
 */
public class PrioridadeEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public PrioridadeEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new PrioridadeItemSemanticEditPolicy());
