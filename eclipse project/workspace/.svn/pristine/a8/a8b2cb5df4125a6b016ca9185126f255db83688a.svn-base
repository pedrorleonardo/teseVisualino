...
import farrusco.diagram.edit.policies.SequencialItemSemanticEditPolicy;
import farrusco.diagram.providers.FarruscoElementTypes;

/**
 * @generated
 */
public class SequencialEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public SequencialEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new SequencialItemSemanticEditPolicy());
	...
	protected IFigure createNodeShape() {
		return primaryShape = new figuresPlan.figures.SequencialFigure();
	}

	/**
	 * @generated
	 */
	public figuresPlan.figures.SequencialFigure getPrimaryShape() {
		return (figuresPlan.figures.SequencialFigure) primaryShape;
	}
