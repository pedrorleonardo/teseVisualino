 ...
 * @generated
 */
public class FarruscoElementChooserDialog extends Dialog {
	 ...
	 * @generated
	 */
	public FarruscoElementChooserDialog(Shell parentShell, View view) {
		super(parentShell);
	...
	protected Control createDialogArea(Composite parent) {
		...
		getShell().setText(
				Messages.FarruscoElementChooserDialog_SelectModelElementTitle);
	...
	private boolean isValidModelFile(IFile file) {
		...
		return "farrusco".equals(fileExtension); //$NON-NLS-1$
	}
