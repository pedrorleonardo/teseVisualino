...
import farrusco.diagram.part.FarruscoDiagramEditorUtil;

/**
 * @generated
 */
public class FarruscoMarkerNavigationProvider extends
		AbstractModelMarkerNavigationProvider {

	/**
	 * @generated
	 */
	public static final String MARKER_TYPE = FarruscoDiagramEditorPlugin.ID
	...
	protected void doGotoMarker(IMarker marker) {
		...
		if (targetEditPart != null) {
			FarruscoDiagramEditorUtil.selectElementsInDiagram(editor,
