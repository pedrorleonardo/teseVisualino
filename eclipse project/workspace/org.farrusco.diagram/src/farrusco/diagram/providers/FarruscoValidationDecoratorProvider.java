 ...
 * @generated
 */
public class FarruscoValidationDecoratorProvider extends AbstractProvider
	 ...
	 * @generated
	 */
	private static final String MARKER_TYPE = FarruscoDiagramEditorPlugin.ID
	...
	public void createDecorators(IDecoratorTarget decoratorTarget) {
		...
		if (editPart instanceof GraphicalEditPart
			...
			if (((DiagramEditDomain) ed).getEditorPart() instanceof FarruscoDiagramEditor) {
	...
	public boolean provides(IOperation operation) {
		...
		return view != null
				&& RobotEditPart.MODEL_ID.equals(FarruscoVisualIDRegistry
						.getModelID(view));
	}
