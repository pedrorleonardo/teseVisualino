...
import farrusco.diagram.edit.policies.DistanciaItemSemanticEditPolicy;
import farrusco.diagram.providers.FarruscoElementTypes;

/**
 * @generated
 */
public class DistanciaEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public DistanciaEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new DistanciaItemSemanticEditPolicy());
	...
	protected IFigure createNodeShape() {
		return primaryShape = new figuresPlan.figures.DistanciaFigure();
	}

	/**
	 * @generated
	 */
	public figuresPlan.figures.DistanciaFigure getPrimaryShape() {
		return (figuresPlan.figures.DistanciaFigure) primaryShape;
	}
