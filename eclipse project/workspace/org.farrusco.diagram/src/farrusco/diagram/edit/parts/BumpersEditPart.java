...
import farrusco.diagram.edit.policies.BumpersItemSemanticEditPolicy;
import farrusco.diagram.providers.FarruscoElementTypes;

/**
 * @generated
 */
public class BumpersEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public BumpersEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new BumpersItemSemanticEditPolicy());
	...
	protected IFigure createNodeShape() {
		return primaryShape = new figuresPlan.figures.BumpersFigure();
	}

	/**
	 * @generated
	 */
	public figuresPlan.figures.BumpersFigure getPrimaryShape() {
		return (figuresPlan.figures.BumpersFigure) primaryShape;
	}
