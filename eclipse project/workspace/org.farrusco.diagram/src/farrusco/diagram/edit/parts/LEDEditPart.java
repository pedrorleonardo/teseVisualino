...
import farrusco.diagram.edit.policies.LEDItemSemanticEditPolicy;
import farrusco.diagram.providers.FarruscoElementTypes;

/**
 * @generated
 */
public class LEDEditPart extends ShapeNodeEditPart {
	...
	protected IFigure createNodeShape() {
		return primaryShape = new figuresPlan.figures.LEDFigure();
	}

	/**
	 * @generated
	 */
	public figuresPlan.figures.LEDFigure getPrimaryShape() {
		return (figuresPlan.figures.LEDFigure) primaryShape;
	}
