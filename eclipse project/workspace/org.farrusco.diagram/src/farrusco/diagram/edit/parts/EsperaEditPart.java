...
import farrusco.diagram.edit.policies.EsperaItemSemanticEditPolicy;
import farrusco.diagram.providers.FarruscoElementTypes;

/**
 * @generated
 */
public class EsperaEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public EsperaEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new EsperaItemSemanticEditPolicy());
	...
	protected IFigure createNodeShape() {
		return primaryShape = new figuresPlan.figures.EsperaFigure();
	}

	/**
	 * @generated
	 */
	public figuresPlan.figures.EsperaFigure getPrimaryShape() {
		return (figuresPlan.figures.EsperaFigure) primaryShape;
	}
