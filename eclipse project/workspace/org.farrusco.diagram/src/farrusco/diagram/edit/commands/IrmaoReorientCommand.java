 ...
 * @generated
 */
public class IrmaoReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public IrmaoReorientCommand(ReorientRelationshipRequest request) {
	...
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof Irmao) {
			return false;
		}
	...
	protected boolean canReorientSource() {
		...
		return FarruscoBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistIrmao_4002(container, getLink(), getNewSource(),
						target);
	}
	...
	protected boolean canReorientTarget() {
		...
		Node source = (Node) getLink().getSource().get(0);
		if (!(getLink().eContainer() instanceof Robot)) {
			return false;
		}
		Robot container = (Robot) getLink().eContainer();
		return FarruscoBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistIrmao_4002(container, getLink(), source,
						getNewTarget());
	}
	 ...
	 * @generated
	 */
	protected Irmao getLink() {
		return (Irmao) getElementToEdit();
	}
