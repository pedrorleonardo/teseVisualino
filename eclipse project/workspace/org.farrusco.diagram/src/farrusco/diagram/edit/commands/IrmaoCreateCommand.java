 ...
 * @generated
 */
public class IrmaoCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public IrmaoCreateCommand(CreateRelationshipRequest request,
	...
	public boolean canExecute() {
		...
		return FarruscoBaseItemSemanticEditPolicy.getLinkConstraints()
				.canCreateIrmao_4002(getContainer(), getSource(), getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		Irmao newElement = FarruscoFactory.eINSTANCE.createIrmao();
		getContainer().getNext().add(newElement);
	 ...
	 * @generated
	 */
	protected void doConfigure(Irmao newElement, IProgressMonitor monitor,
			IAdaptable info) throws ExecutionException {
