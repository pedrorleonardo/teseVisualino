...
import arduino.diagram.part.ArduinoDiagramEditor;
 ...
 * @generated
 */
public class ArduinoValidationDecoratorProvider extends AbstractProvider
	 ...
	 * @generated
	 */
	private static final String MARKER_TYPE = ArduinoDiagramEditorPlugin.ID
	...
	public void createDecorators(IDecoratorTarget decoratorTarget) {
		...
		if (editPart instanceof GraphicalEditPart
			...
			if (((DiagramEditDomain) ed).getEditorPart() instanceof ArduinoDiagramEditor) {
	...
	public boolean provides(IOperation operation) {
		...
		return view != null
				&& RoboEditPart.MODEL_ID.equals(ArduinoVisualIDRegistry
						.getModelID(view));
	}
