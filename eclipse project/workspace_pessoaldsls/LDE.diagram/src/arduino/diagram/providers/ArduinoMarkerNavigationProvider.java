...
import arduino.diagram.part.ArduinoDiagramEditorUtil;

/**
 * @generated
 */
public class ArduinoMarkerNavigationProvider extends
		AbstractModelMarkerNavigationProvider {

	/**
	 * @generated
	 */
	public static final String MARKER_TYPE = ArduinoDiagramEditorPlugin.ID
	...
	protected void doGotoMarker(IMarker marker) {
		...
		if (targetEditPart != null) {
			ArduinoDiagramEditorUtil.selectElementsInDiagram(editor,
