...
import arduino.diagram.edit.policies.Desligar_LED_VerdeItemSemanticEditPolicy;
 ...
 * @generated
 */
public class Desligar_LED_VerdeEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public Desligar_LED_VerdeEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new Desligar_LED_VerdeItemSemanticEditPolicy());
	...
	protected IFigure createNodeShape() {
		return primaryShape = new Desligar_LED_VerdeFigure();
	}

	/**
	 * @generated
	 */
	public Desligar_LED_VerdeFigure getPrimaryShape() {
		return (Desligar_LED_VerdeFigure) primaryShape;
	}
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof Desligar_LED_VerdeNomeEditPart) {
			((Desligar_LED_VerdeNomeEditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigureDesligar_LED_VerdeLabelFigure());
			return true;
		}
		return false;
	}
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof arduino.diagram.edit.parts.Desligar_LED_VerdeEditPart) {
			types.add(ArduinoElementTypes.Transicoes_4001);
		}
	 ...
	 * @generated
	 */
	public class Desligar_LED_VerdeFigure extends Ellipse {

		/**
		 * @generated
		 */
		private WrappingLabel fFigureDesligar_LED_VerdeLabelFigure;

		/**
		 * @generated
		 */
		public Desligar_LED_VerdeFigure() {
		...
		private void createContents() {
			...
			fFigureDesligar_LED_VerdeLabelFigure = new WrappingLabel();

			fFigureDesligar_LED_VerdeLabelFigure.setText("Desligar_LED_Verde");

			this.add(fFigureDesligar_LED_VerdeLabelFigure);
		 ...
		 * @generated
		 */
		public WrappingLabel getFigureDesligar_LED_VerdeLabelFigure() {
			return fFigureDesligar_LED_VerdeLabelFigure;
		}
