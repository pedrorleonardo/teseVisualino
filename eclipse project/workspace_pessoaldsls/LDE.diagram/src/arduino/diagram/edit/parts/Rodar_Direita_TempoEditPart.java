...
import arduino.diagram.edit.policies.Rodar_Direita_TempoItemSemanticEditPolicy;
 ...
 * @generated
 */
public class Rodar_Direita_TempoEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public Rodar_Direita_TempoEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new Rodar_Direita_TempoItemSemanticEditPolicy());
	...
	protected IFigure createNodeShape() {
		return primaryShape = new Rodar_Direita_TempoFigure();
	}

	/**
	 * @generated
	 */
	public Rodar_Direita_TempoFigure getPrimaryShape() {
		return (Rodar_Direita_TempoFigure) primaryShape;
	}
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof Rodar_Direita_TempoTempoEditPart) {
			((Rodar_Direita_TempoTempoEditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigureRodar_Direita_TempoLabelFigure());
			return true;
		}
		return false;
	}
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof arduino.diagram.edit.parts.Rodar_Direita_TempoEditPart) {
			types.add(ArduinoElementTypes.Transicoes_4001);
		}
	 ...
	 * @generated
	 */
	public class Rodar_Direita_TempoFigure extends Ellipse {

		/**
		 * @generated
		 */
		private WrappingLabel fFigureRodar_Direita_TempoLabelFigure;

		/**
		 * @generated
		 */
		public Rodar_Direita_TempoFigure() {
		...
		private void createContents() {
			...
			fFigureRodar_Direita_TempoLabelFigure = new WrappingLabel();

			fFigureRodar_Direita_TempoLabelFigure
					.setText("Rodar_Direita_Tempo");

			this.add(fFigureRodar_Direita_TempoLabelFigure);
		 ...
		 * @generated
		 */
		public WrappingLabel getFigureRodar_Direita_TempoLabelFigure() {
			return fFigureRodar_Direita_TempoLabelFigure;
		}
