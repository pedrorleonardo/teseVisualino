 ...
 * @generated
 */
public class Ligar_IntermitenciaNomeEditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public Ligar_IntermitenciaNomeEditPart(View view) {
		super(view);
	}
			...
			parser = ArduinoParserProvider
					.getParser(
							...
							ArduinoVisualIDRegistry
									.getType(arduino.diagram.edit.parts.Ligar_IntermitenciaNomeEditPart.VISUAL_ID));
		}
		return parser;
	}
