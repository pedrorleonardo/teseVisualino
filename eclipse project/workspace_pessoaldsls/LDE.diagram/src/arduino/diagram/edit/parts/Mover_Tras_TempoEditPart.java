...
import arduino.diagram.edit.policies.Mover_Tras_TempoItemSemanticEditPolicy;
 ...
 * @generated
 */
public class Mover_Tras_TempoEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public Mover_Tras_TempoEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new Mover_Tras_TempoItemSemanticEditPolicy());
	...
	protected IFigure createNodeShape() {
		return primaryShape = new Mover_Tras_TempoFigure();
	}

	/**
	 * @generated
	 */
	public Mover_Tras_TempoFigure getPrimaryShape() {
		return (Mover_Tras_TempoFigure) primaryShape;
	}
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof Mover_Tras_TempoTempoEditPart) {
			((Mover_Tras_TempoTempoEditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigureMover_Tras_TempoLabelFigure());
			return true;
		}
		return false;
	}
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof arduino.diagram.edit.parts.Mover_Tras_TempoEditPart) {
			types.add(ArduinoElementTypes.Transicoes_4001);
		}
	 ...
	 * @generated
	 */
	public class Mover_Tras_TempoFigure extends Ellipse {

		/**
		 * @generated
		 */
		private WrappingLabel fFigureMover_Tras_TempoLabelFigure;

		/**
		 * @generated
		 */
		public Mover_Tras_TempoFigure() {
		...
		private void createContents() {
			...
			fFigureMover_Tras_TempoLabelFigure = new WrappingLabel();

			fFigureMover_Tras_TempoLabelFigure.setText("Mover_Tras_Tempo");

			this.add(fFigureMover_Tras_TempoLabelFigure);
		 ...
		 * @generated
		 */
		public WrappingLabel getFigureMover_Tras_TempoLabelFigure() {
			return fFigureMover_Tras_TempoLabelFigure;
		}
