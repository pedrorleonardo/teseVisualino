...
import arduino.diagram.edit.policies.WhileItemSemanticEditPolicy;
...
public class WhileEditPart extends ShapeNodeEditPart {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof WhileNomeEditPart) {
			((WhileNomeEditPart) childEditPart).setLabel(getPrimaryShape()
					.getFigureWhileLabelFigure());
			return true;
		}
		return false;
	}
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(ArduinoVisualIDRegistry
				.getType(WhileNomeEditPart.VISUAL_ID));
	}
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof arduino.diagram.edit.parts.WhileEditPart) {
			types.add(ArduinoElementTypes.Transicoes_4001);
		}
	 ...
	 * @generated
	 */
	public class WhileFigure extends Ellipse {
