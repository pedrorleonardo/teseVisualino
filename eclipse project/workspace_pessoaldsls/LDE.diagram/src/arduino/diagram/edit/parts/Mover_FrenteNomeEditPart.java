 ...
 * @generated
 */
public class Mover_FrenteNomeEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public Mover_FrenteNomeEditPart(View view) {
		super(view);
	}
			...
			parser = ArduinoParserProvider
					.getParser(
							...
							ArduinoVisualIDRegistry
									.getType(arduino.diagram.edit.parts.Mover_FrenteNomeEditPart.VISUAL_ID));
		}
		return parser;
	}
