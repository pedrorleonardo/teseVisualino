 ...
 * @generated
 */
public class Ligar_VermelhoNomeEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public Ligar_VermelhoNomeEditPart(View view) {
		super(view);
	}
			...
			parser = ArduinoParserProvider
					.getParser(
							...
							ArduinoVisualIDRegistry
									.getType(arduino.diagram.edit.parts.Ligar_VermelhoNomeEditPart.VISUAL_ID));
		}
		return parser;
	}
