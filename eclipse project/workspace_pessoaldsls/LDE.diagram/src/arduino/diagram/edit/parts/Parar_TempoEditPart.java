...
import arduino.diagram.edit.policies.Parar_TempoItemSemanticEditPolicy;
 ...
 * @generated
 */
public class Parar_TempoEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public Parar_TempoEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new Parar_TempoItemSemanticEditPolicy());
	...
	protected IFigure createNodeShape() {
		return primaryShape = new Parar_TempoFigure();
	}

	/**
	 * @generated
	 */
	public Parar_TempoFigure getPrimaryShape() {
		return (Parar_TempoFigure) primaryShape;
	}
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof Parar_TempoTempoEditPart) {
			((Parar_TempoTempoEditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigureParar_TempoLabelFigure());
			return true;
		}
		return false;
	}
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof arduino.diagram.edit.parts.Parar_TempoEditPart) {
			types.add(ArduinoElementTypes.Transicoes_4001);
		}
	 ...
	 * @generated
	 */
	public class Parar_TempoFigure extends Ellipse {

		/**
		 * @generated
		 */
		private WrappingLabel fFigureParar_TempoLabelFigure;

		/**
		 * @generated
		 */
		public Parar_TempoFigure() {
		...
		private void createContents() {
			...
			fFigureParar_TempoLabelFigure = new WrappingLabel();

			fFigureParar_TempoLabelFigure.setText("Parar_Tempo");

			this.add(fFigureParar_TempoLabelFigure);
		 ...
		 * @generated
		 */
		public WrappingLabel getFigureParar_TempoLabelFigure() {
			return fFigureParar_TempoLabelFigure;
		}
