...
import arduino.diagram.edit.policies.Virar_45_DrtItemSemanticEditPolicy;
 ...
 * @generated
 */
public class Virar_45_DrtEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public Virar_45_DrtEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new Virar_45_DrtItemSemanticEditPolicy());
	...
	protected IFigure createNodeShape() {
		return primaryShape = new Virar_45_DrtFigure();
	}

	/**
	 * @generated
	 */
	public Virar_45_DrtFigure getPrimaryShape() {
		return (Virar_45_DrtFigure) primaryShape;
	}
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof Virar_45_DrtNomeEditPart) {
			((Virar_45_DrtNomeEditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigureVirar_45_DrtLabelFigure());
			return true;
		}
		return false;
	}
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof arduino.diagram.edit.parts.Virar_45_DrtEditPart) {
			types.add(ArduinoElementTypes.Transicoes_4001);
		}
	 ...
	 * @generated
	 */
	public class Virar_45_DrtFigure extends Ellipse {

		/**
		 * @generated
		 */
		private WrappingLabel fFigureVirar_45_DrtLabelFigure;

		/**
		 * @generated
		 */
		public Virar_45_DrtFigure() {
		...
		private void createContents() {
			...
			fFigureVirar_45_DrtLabelFigure = new WrappingLabel();

			fFigureVirar_45_DrtLabelFigure.setText("Virar_45_Drt");

			this.add(fFigureVirar_45_DrtLabelFigure);
		 ...
		 * @generated
		 */
		public WrappingLabel getFigureVirar_45_DrtLabelFigure() {
			return fFigureVirar_45_DrtLabelFigure;
		}
