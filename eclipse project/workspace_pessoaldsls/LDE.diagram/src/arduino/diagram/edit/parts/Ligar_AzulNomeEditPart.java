 ...
 * @generated
 */
public class Ligar_AzulNomeEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public Ligar_AzulNomeEditPart(View view) {
		super(view);
	}
			...
			parser = ArduinoParserProvider
					.getParser(
							...
							ArduinoVisualIDRegistry
									.getType(arduino.diagram.edit.parts.Ligar_AzulNomeEditPart.VISUAL_ID));
		}
		return parser;
	}
