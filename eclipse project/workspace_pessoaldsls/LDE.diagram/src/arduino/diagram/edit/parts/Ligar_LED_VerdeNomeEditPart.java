 ...
 * @generated
 */
public class Ligar_LED_VerdeNomeEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public Ligar_LED_VerdeNomeEditPart(View view) {
		super(view);
	}
			...
			parser = ArduinoParserProvider
					.getParser(
							...
							ArduinoVisualIDRegistry
									.getType(arduino.diagram.edit.parts.Ligar_LED_VerdeNomeEditPart.VISUAL_ID));
		}
		return parser;
	}
