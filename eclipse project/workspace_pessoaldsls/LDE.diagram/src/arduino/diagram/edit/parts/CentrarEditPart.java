...
import arduino.diagram.edit.policies.CentrarItemSemanticEditPolicy;
 ...
 * @generated
 */
public class CentrarEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public CentrarEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new CentrarItemSemanticEditPolicy());
	...
	protected IFigure createNodeShape() {
		return primaryShape = new CentrarFigure();
	}

	/**
	 * @generated
	 */
	public CentrarFigure getPrimaryShape() {
		return (CentrarFigure) primaryShape;
	}
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof CentrarNomeEditPart) {
			((CentrarNomeEditPart) childEditPart).setLabel(getPrimaryShape()
					.getFigureCentrarLabelFigure());
			return true;
		}
		return false;
	}
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(ArduinoVisualIDRegistry
				.getType(CentrarNomeEditPart.VISUAL_ID));
	}
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof arduino.diagram.edit.parts.CentrarEditPart) {
			types.add(ArduinoElementTypes.Transicoes_4001);
		}
	 ...
	 * @generated
	 */
	public class CentrarFigure extends Ellipse {

		/**
		 * @generated
		 */
		private WrappingLabel fFigureCentrarLabelFigure;

		/**
		 * @generated
		 */
		public CentrarFigure() {
		...
		private void createContents() {
			...
			fFigureCentrarLabelFigure = new WrappingLabel();

			fFigureCentrarLabelFigure.setText("Centrar");

			this.add(fFigureCentrarLabelFigure);
		 ...
		 * @generated
		 */
		public WrappingLabel getFigureCentrarLabelFigure() {
			return fFigureCentrarLabelFigure;
		}
