...
import arduino.diagram.edit.policies.Virar_Max_DrtItemSemanticEditPolicy;
 ...
 * @generated
 */
public class Virar_Max_DrtEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public Virar_Max_DrtEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new Virar_Max_DrtItemSemanticEditPolicy());
	...
	protected IFigure createNodeShape() {
		return primaryShape = new Virar_Max_DrtFigure();
	}

	/**
	 * @generated
	 */
	public Virar_Max_DrtFigure getPrimaryShape() {
		return (Virar_Max_DrtFigure) primaryShape;
	}
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof Virar_Max_DrtNomeEditPart) {
			((Virar_Max_DrtNomeEditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigureVirar_Max_DrtLabelFigure());
			return true;
		}
		return false;
	}
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof arduino.diagram.edit.parts.Virar_Max_DrtEditPart) {
			types.add(ArduinoElementTypes.Transicoes_4001);
		}
	 ...
	 * @generated
	 */
	public class Virar_Max_DrtFigure extends Ellipse {

		/**
		 * @generated
		 */
		private WrappingLabel fFigureVirar_Max_DrtLabelFigure;

		/**
		 * @generated
		 */
		public Virar_Max_DrtFigure() {
		...
		private void createContents() {
			...
			fFigureVirar_Max_DrtLabelFigure = new WrappingLabel();

			fFigureVirar_Max_DrtLabelFigure.setText("Virar_Max_Drt");

			this.add(fFigureVirar_Max_DrtLabelFigure);
		 ...
		 * @generated
		 */
		public WrappingLabel getFigureVirar_Max_DrtLabelFigure() {
			return fFigureVirar_Max_DrtLabelFigure;
		}
