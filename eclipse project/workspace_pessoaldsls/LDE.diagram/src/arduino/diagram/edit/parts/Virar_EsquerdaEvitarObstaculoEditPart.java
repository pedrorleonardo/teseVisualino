 ...
 * @generated
 */
public class Virar_EsquerdaEvitarObstaculoEditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public Virar_EsquerdaEvitarObstaculoEditPart(View view) {
		super(view);
	}
			...
			parser = ArduinoParserProvider
					.getParser(
							...
							ArduinoVisualIDRegistry
									.getType(arduino.diagram.edit.parts.Virar_EsquerdaEvitarObstaculoEditPart.VISUAL_ID));
		}
		return parser;
	}
