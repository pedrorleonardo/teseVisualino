 ...
 * @generated
 */
public class Mover_Frente_TempoTempoEditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public Mover_Frente_TempoTempoEditPart(View view) {
		super(view);
	}
			...
			parser = ArduinoParserProvider
					.getParser(
							...
							ArduinoVisualIDRegistry
									.getType(arduino.diagram.edit.parts.Mover_Frente_TempoTempoEditPart.VISUAL_ID));
		}
		return parser;
	}
