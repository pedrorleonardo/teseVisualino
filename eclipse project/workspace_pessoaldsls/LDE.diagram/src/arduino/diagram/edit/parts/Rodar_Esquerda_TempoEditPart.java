...
import arduino.diagram.edit.policies.Rodar_Esquerda_TempoItemSemanticEditPolicy;
 ...
 * @generated
 */
public class Rodar_Esquerda_TempoEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public Rodar_Esquerda_TempoEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new Rodar_Esquerda_TempoItemSemanticEditPolicy());
	...
	protected IFigure createNodeShape() {
		return primaryShape = new Rodar_Esquerda_TempoFigure();
	}

	/**
	 * @generated
	 */
	public Rodar_Esquerda_TempoFigure getPrimaryShape() {
		return (Rodar_Esquerda_TempoFigure) primaryShape;
	}
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof Rodar_Esquerda_TempoTempoEditPart) {
			((Rodar_Esquerda_TempoTempoEditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigureRodar_Esquerda_TempoLabelFigure());
			return true;
		}
		return false;
	}
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof arduino.diagram.edit.parts.Rodar_Esquerda_TempoEditPart) {
			types.add(ArduinoElementTypes.Transicoes_4001);
		}
	 ...
	 * @generated
	 */
	public class Rodar_Esquerda_TempoFigure extends Ellipse {

		/**
		 * @generated
		 */
		private WrappingLabel fFigureRodar_Esquerda_TempoLabelFigure;

		/**
		 * @generated
		 */
		public Rodar_Esquerda_TempoFigure() {
		...
		private void createContents() {
			...
			fFigureRodar_Esquerda_TempoLabelFigure = new WrappingLabel();

			fFigureRodar_Esquerda_TempoLabelFigure
					.setText("Rodar_Esquerda_Tempo");

			this.add(fFigureRodar_Esquerda_TempoLabelFigure);
		 ...
		 * @generated
		 */
		public WrappingLabel getFigureRodar_Esquerda_TempoLabelFigure() {
			return fFigureRodar_Esquerda_TempoLabelFigure;
		}
	 ...
	 * @generated
	 */
	static final Color THIS_FORE = new Color(null, 64, 207, 255);

	/**
	 * @generated
	 */
	static final Color THIS_BACK = new Color(null, 64, 207, 255);
