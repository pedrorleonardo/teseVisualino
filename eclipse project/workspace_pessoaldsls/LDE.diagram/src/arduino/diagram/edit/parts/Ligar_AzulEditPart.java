...
import arduino.diagram.edit.policies.Ligar_AzulItemSemanticEditPolicy;
 ...
 * @generated
 */
public class Ligar_AzulEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public Ligar_AzulEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new Ligar_AzulItemSemanticEditPolicy());
	...
	protected IFigure createNodeShape() {
		return primaryShape = new Ligar_AzulFigure();
	}

	/**
	 * @generated
	 */
	public Ligar_AzulFigure getPrimaryShape() {
		return (Ligar_AzulFigure) primaryShape;
	}
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof Ligar_AzulNomeEditPart) {
			((Ligar_AzulNomeEditPart) childEditPart).setLabel(getPrimaryShape()
					.getFigureLigar_AzulLabelFigure());
			return true;
		}
		return false;
	}
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof arduino.diagram.edit.parts.Ligar_AzulEditPart) {
			types.add(ArduinoElementTypes.Transicoes_4001);
		}
	 ...
	 * @generated
	 */
	public class Ligar_AzulFigure extends Ellipse {

		/**
		 * @generated
		 */
		private WrappingLabel fFigureLigar_AzulLabelFigure;

		/**
		 * @generated
		 */
		public Ligar_AzulFigure() {
		...
		private void createContents() {
			...
			fFigureLigar_AzulLabelFigure = new WrappingLabel();

			fFigureLigar_AzulLabelFigure.setText("Ligar_Azul");

			this.add(fFigureLigar_AzulLabelFigure);
		 ...
		 * @generated
		 */
		public WrappingLabel getFigureLigar_AzulLabelFigure() {
			return fFigureLigar_AzulLabelFigure;
		}
