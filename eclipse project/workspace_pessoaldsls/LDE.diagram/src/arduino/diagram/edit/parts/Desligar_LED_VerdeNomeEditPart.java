 ...
 * @generated
 */
public class Desligar_LED_VerdeNomeEditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public Desligar_LED_VerdeNomeEditPart(View view) {
		super(view);
	}
			...
			parser = ArduinoParserProvider
					.getParser(
							...
							ArduinoVisualIDRegistry
									.getType(arduino.diagram.edit.parts.Desligar_LED_VerdeNomeEditPart.VISUAL_ID));
		}
		return parser;
	}
