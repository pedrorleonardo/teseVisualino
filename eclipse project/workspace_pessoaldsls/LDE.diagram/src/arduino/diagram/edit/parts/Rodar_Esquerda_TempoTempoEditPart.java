 ...
 * @generated
 */
public class Rodar_Esquerda_TempoTempoEditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public Rodar_Esquerda_TempoTempoEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = ArduinoParserProvider
					.getParser(
							ArduinoElementTypes.Rodar_Esquerda_Tempo_2016,
							getParserElement(),
							ArduinoVisualIDRegistry
									.getType(arduino.diagram.edit.parts.Rodar_Esquerda_TempoTempoEditPart.VISUAL_ID));
		}
		return parser;
	}
