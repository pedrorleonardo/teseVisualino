 ...
 * @generated
 */
public class Virar_EsquerdaNomeEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public Virar_EsquerdaNomeEditPart(View view) {
		super(view);
	}
			...
			parser = ArduinoParserProvider
					.getParser(
							...
							ArduinoVisualIDRegistry
									.getType(arduino.diagram.edit.parts.Virar_EsquerdaNomeEditPart.VISUAL_ID));
		}
		return parser;
	}
