...
import arduino.diagram.edit.policies.Desligar_CoresItemSemanticEditPolicy;
 ...
 * @generated
 */
public class Desligar_CoresEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public Desligar_CoresEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new Desligar_CoresItemSemanticEditPolicy());
	...
	protected IFigure createNodeShape() {
		return primaryShape = new Desligar_CoresFigure();
	}

	/**
	 * @generated
	 */
	public Desligar_CoresFigure getPrimaryShape() {
		return (Desligar_CoresFigure) primaryShape;
	}
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof Desligar_CoresNomeEditPart) {
			((Desligar_CoresNomeEditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigureDesligar_CoresLabelFigure());
			return true;
		}
		return false;
	}
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof arduino.diagram.edit.parts.Desligar_CoresEditPart) {
			types.add(ArduinoElementTypes.Transicoes_4001);
		}
	 ...
	 * @generated
	 */
	public class Desligar_CoresFigure extends Ellipse {

		/**
		 * @generated
		 */
		private WrappingLabel fFigureDesligar_CoresLabelFigure;

		/**
		 * @generated
		 */
		public Desligar_CoresFigure() {
		...
		private void createContents() {
			...
			fFigureDesligar_CoresLabelFigure = new WrappingLabel();

			fFigureDesligar_CoresLabelFigure.setText("Desligar_Cores");

			this.add(fFigureDesligar_CoresLabelFigure);
		 ...
		 * @generated
		 */
		public WrappingLabel getFigureDesligar_CoresLabelFigure() {
			return fFigureDesligar_CoresLabelFigure;
		}
