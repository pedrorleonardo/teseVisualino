...
import arduino.diagram.edit.policies.Virar_para_X_GrausItemSemanticEditPolicy;
 ...
 * @generated
 */
public class Virar_para_X_GrausEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public Virar_para_X_GrausEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new Virar_para_X_GrausItemSemanticEditPolicy());
	...
	protected IFigure createNodeShape() {
		return primaryShape = new Virar_para_X_GrausFigure();
	}

	/**
	 * @generated
	 */
	public Virar_para_X_GrausFigure getPrimaryShape() {
		return (Virar_para_X_GrausFigure) primaryShape;
	}
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof Virar_para_X_GrausGrausEditPart) {
			((Virar_para_X_GrausGrausEditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigureVirar_para_X_GrausLabelFigure());
			return true;
		}
		return false;
	}
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof arduino.diagram.edit.parts.Virar_para_X_GrausEditPart) {
			types.add(ArduinoElementTypes.Transicoes_4001);
		}
	 ...
	 * @generated
	 */
	public class Virar_para_X_GrausFigure extends Ellipse {

		/**
		 * @generated
		 */
		private WrappingLabel fFigureVirar_para_X_GrausLabelFigure;

		/**
		 * @generated
		 */
		public Virar_para_X_GrausFigure() {
		...
		private void createContents() {
			...
			fFigureVirar_para_X_GrausLabelFigure = new WrappingLabel();

			fFigureVirar_para_X_GrausLabelFigure.setText("Virar_para_X_Graus");

			this.add(fFigureVirar_para_X_GrausLabelFigure);
		 ...
		 * @generated
		 */
		public WrappingLabel getFigureVirar_para_X_GrausLabelFigure() {
			return fFigureVirar_para_X_GrausLabelFigure;
		}
