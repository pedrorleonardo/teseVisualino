...
import arduino.diagram.edit.policies.Ligar_LED_VerdeItemSemanticEditPolicy;
 ...
 * @generated
 */
public class Ligar_LED_VerdeEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public Ligar_LED_VerdeEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new Ligar_LED_VerdeItemSemanticEditPolicy());
	...
	protected IFigure createNodeShape() {
		return primaryShape = new Ligar_LED_VerdeFigure();
	}

	/**
	 * @generated
	 */
	public Ligar_LED_VerdeFigure getPrimaryShape() {
		return (Ligar_LED_VerdeFigure) primaryShape;
	}
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof Ligar_LED_VerdeNomeEditPart) {
			((Ligar_LED_VerdeNomeEditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigureLigar_LED_VerdeLabelFigure());
			return true;
		}
		return false;
	}
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof arduino.diagram.edit.parts.Ligar_LED_VerdeEditPart) {
			types.add(ArduinoElementTypes.Transicoes_4001);
		}
	 ...
	 * @generated
	 */
	public class Ligar_LED_VerdeFigure extends Ellipse {

		/**
		 * @generated
		 */
		private WrappingLabel fFigureLigar_LED_VerdeLabelFigure;

		/**
		 * @generated
		 */
		public Ligar_LED_VerdeFigure() {
		...
		private void createContents() {
			...
			fFigureLigar_LED_VerdeLabelFigure = new WrappingLabel();

			fFigureLigar_LED_VerdeLabelFigure.setText("Ligar_LED_Verde");

			this.add(fFigureLigar_LED_VerdeLabelFigure);
		 ...
		 * @generated
		 */
		public WrappingLabel getFigureLigar_LED_VerdeLabelFigure() {
			return fFigureLigar_LED_VerdeLabelFigure;
		}
