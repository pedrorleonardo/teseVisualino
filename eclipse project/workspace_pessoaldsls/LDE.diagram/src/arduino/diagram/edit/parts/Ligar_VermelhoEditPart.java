...
import arduino.diagram.edit.policies.Ligar_VermelhoItemSemanticEditPolicy;
 ...
 * @generated
 */
public class Ligar_VermelhoEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public Ligar_VermelhoEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new Ligar_VermelhoItemSemanticEditPolicy());
	...
	protected IFigure createNodeShape() {
		return primaryShape = new Ligar_VermelhoFigure();
	}

	/**
	 * @generated
	 */
	public Ligar_VermelhoFigure getPrimaryShape() {
		return (Ligar_VermelhoFigure) primaryShape;
	}
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof Ligar_VermelhoNomeEditPart) {
			((Ligar_VermelhoNomeEditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigureLigar_VermelhoLabelFigure());
			return true;
		}
		return false;
	}
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof arduino.diagram.edit.parts.Ligar_VermelhoEditPart) {
			types.add(ArduinoElementTypes.Transicoes_4001);
		}
	 ...
	 * @generated
	 */
	public class Ligar_VermelhoFigure extends Ellipse {

		/**
		 * @generated
		 */
		private WrappingLabel fFigureLigar_VermelhoLabelFigure;

		/**
		 * @generated
		 */
		public Ligar_VermelhoFigure() {
		...
		private void createContents() {
			...
			fFigureLigar_VermelhoLabelFigure = new WrappingLabel();

			fFigureLigar_VermelhoLabelFigure.setText("Ligar_Vermelho");

			this.add(fFigureLigar_VermelhoLabelFigure);
		 ...
		 * @generated
		 */
		public WrappingLabel getFigureLigar_VermelhoLabelFigure() {
			return fFigureLigar_VermelhoLabelFigure;
		}
