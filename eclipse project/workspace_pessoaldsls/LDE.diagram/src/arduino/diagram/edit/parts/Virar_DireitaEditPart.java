...
import arduino.diagram.edit.policies.Virar_DireitaItemSemanticEditPolicy;
 ...
 * @generated
 */
public class Virar_DireitaEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public Virar_DireitaEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new Virar_DireitaItemSemanticEditPolicy());
	...
	protected IFigure createNodeShape() {
		return primaryShape = new Virar_DireitaFigure();
	}

	/**
	 * @generated
	 */
	public Virar_DireitaFigure getPrimaryShape() {
		return (Virar_DireitaFigure) primaryShape;
	}
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof Virar_DireitaNomeEditPart) {
			((Virar_DireitaNomeEditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigureVirar_DireitaLabelFigure());
			return true;
		}
		return false;
	}
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof arduino.diagram.edit.parts.Virar_DireitaEditPart) {
			types.add(ArduinoElementTypes.Transicoes_4001);
		}
	 ...
	 * @generated
	 */
	public class Virar_DireitaFigure extends Ellipse {

		/**
		 * @generated
		 */
		private WrappingLabel fFigureVirar_DireitaLabelFigure;

		/**
		 * @generated
		 */
		public Virar_DireitaFigure() {
		...
		private void createContents() {
			...
			fFigureVirar_DireitaLabelFigure = new WrappingLabel();

			fFigureVirar_DireitaLabelFigure.setText("Virar_Direita");

			this.add(fFigureVirar_DireitaLabelFigure);
		 ...
		 * @generated
		 */
		public WrappingLabel getFigureVirar_DireitaLabelFigure() {
			return fFigureVirar_DireitaLabelFigure;
		}
