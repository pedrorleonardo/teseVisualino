...
import arduino.diagram.edit.policies.Ligar_IntermitenciaItemSemanticEditPolicy;
 ...
 * @generated
 */
public class Ligar_IntermitenciaEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public Ligar_IntermitenciaEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new Ligar_IntermitenciaItemSemanticEditPolicy());
	...
	protected IFigure createNodeShape() {
		return primaryShape = new Ligar_IntermitenciaFigure();
	}

	/**
	 * @generated
	 */
	public Ligar_IntermitenciaFigure getPrimaryShape() {
		return (Ligar_IntermitenciaFigure) primaryShape;
	}
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof Ligar_IntermitenciaNomeEditPart) {
			((Ligar_IntermitenciaNomeEditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigureLigar_IntermitenciaLabelFigure());
			return true;
		}
		return false;
	}
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof arduino.diagram.edit.parts.Ligar_IntermitenciaEditPart) {
			types.add(ArduinoElementTypes.Transicoes_4001);
		}
	 ...
	 * @generated
	 */
	public class Ligar_IntermitenciaFigure extends Ellipse {

		/**
		 * @generated
		 */
		private WrappingLabel fFigureLigar_IntermitenciaLabelFigure;

		/**
		 * @generated
		 */
		public Ligar_IntermitenciaFigure() {
		...
		private void createContents() {
			...
			fFigureLigar_IntermitenciaLabelFigure = new WrappingLabel();

			fFigureLigar_IntermitenciaLabelFigure
					.setText("Ligar_Intermitencia");

			this.add(fFigureLigar_IntermitenciaLabelFigure);
		 ...
		 * @generated
		 */
		public WrappingLabel getFigureLigar_IntermitenciaLabelFigure() {
			return fFigureLigar_IntermitenciaLabelFigure;
		}
