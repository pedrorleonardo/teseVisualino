...
import arduino.diagram.edit.policies.Mover_AleatoriamenteItemSemanticEditPolicy;
 ...
 * @generated
 */
public class Mover_AleatoriamenteEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public Mover_AleatoriamenteEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new Mover_AleatoriamenteItemSemanticEditPolicy());
	...
	protected IFigure createNodeShape() {
		return primaryShape = new Mover_AleatoriamenteFigure();
	}

	/**
	 * @generated
	 */
	public Mover_AleatoriamenteFigure getPrimaryShape() {
		return (Mover_AleatoriamenteFigure) primaryShape;
	}
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof Mover_AleatoriamenteNomeEditPart) {
			((Mover_AleatoriamenteNomeEditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigureMover_AleatoriamenteLabelFigure());
			return true;
		}
		return false;
	}
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof arduino.diagram.edit.parts.Mover_AleatoriamenteEditPart) {
			types.add(ArduinoElementTypes.Transicoes_4001);
		}
	 ...
	 * @generated
	 */
	public class Mover_AleatoriamenteFigure extends Ellipse {

		/**
		 * @generated
		 */
		private WrappingLabel fFigureMover_AleatoriamenteLabelFigure;

		/**
		 * @generated
		 */
		public Mover_AleatoriamenteFigure() {
		...
		private void createContents() {
			...
			fFigureMover_AleatoriamenteLabelFigure = new WrappingLabel();

			fFigureMover_AleatoriamenteLabelFigure
					.setText("Mover_Aleatoriamente");

			this.add(fFigureMover_AleatoriamenteLabelFigure);
		 ...
		 * @generated
		 */
		public WrappingLabel getFigureMover_AleatoriamenteLabelFigure() {
			return fFigureMover_AleatoriamenteLabelFigure;
		}
