 ...
 * @generated
 */
public class Bumper_PressionadoNomeEditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public Bumper_PressionadoNomeEditPart(View view) {
		super(view);
	}
			...
			parser = ArduinoParserProvider
					.getParser(
							...
							ArduinoVisualIDRegistry
									.getType(arduino.diagram.edit.parts.Bumper_PressionadoNomeEditPart.VISUAL_ID));
		}
		return parser;
	}
