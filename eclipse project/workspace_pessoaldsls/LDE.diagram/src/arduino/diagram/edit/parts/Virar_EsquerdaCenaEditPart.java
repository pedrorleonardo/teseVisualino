 ...
 * @generated
 */
public class Virar_EsquerdaCenaEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public Virar_EsquerdaCenaEditPart(View view) {
		super(view);
	}
			...
			parser = ArduinoParserProvider
					.getParser(
							...
							ArduinoVisualIDRegistry
									.getType(arduino.diagram.edit.parts.Virar_EsquerdaCenaEditPart.VISUAL_ID));
		}
		return parser;
	}
