 ...
 * @generated
 */
public class Ligar_Cores_PoliciaNomeEditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public Ligar_Cores_PoliciaNomeEditPart(View view) {
		super(view);
	}
			...
			parser = ArduinoParserProvider
					.getParser(
							...
							ArduinoVisualIDRegistry
									.getType(arduino.diagram.edit.parts.Ligar_Cores_PoliciaNomeEditPart.VISUAL_ID));
		}
		return parser;
	}
