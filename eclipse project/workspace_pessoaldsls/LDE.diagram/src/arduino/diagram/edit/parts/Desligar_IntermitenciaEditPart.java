...
import arduino.diagram.edit.policies.Desligar_IntermitenciaItemSemanticEditPolicy;
 ...
 * @generated
 */
public class Desligar_IntermitenciaEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public Desligar_IntermitenciaEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new Desligar_IntermitenciaItemSemanticEditPolicy());
	...
	protected IFigure createNodeShape() {
		return primaryShape = new Desligar_IntermitenciaFigure();
	}

	/**
	 * @generated
	 */
	public Desligar_IntermitenciaFigure getPrimaryShape() {
		return (Desligar_IntermitenciaFigure) primaryShape;
	}
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof Desligar_IntermitenciaNomeEditPart) {
			((Desligar_IntermitenciaNomeEditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigureDesligar_IntermitenciaLabelFigure());
			return true;
		}
		return false;
	}
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof arduino.diagram.edit.parts.Desligar_IntermitenciaEditPart) {
			types.add(ArduinoElementTypes.Transicoes_4001);
		}
	 ...
	 * @generated
	 */
	public class Desligar_IntermitenciaFigure extends Ellipse {

		/**
		 * @generated
		 */
		private WrappingLabel fFigureDesligar_IntermitenciaLabelFigure;

		/**
		 * @generated
		 */
		public Desligar_IntermitenciaFigure() {
		...
		private void createContents() {
			...
			fFigureDesligar_IntermitenciaLabelFigure = new WrappingLabel();

			fFigureDesligar_IntermitenciaLabelFigure
					.setText("Desligar_Intermitencia");

			this.add(fFigureDesligar_IntermitenciaLabelFigure);
		 ...
		 * @generated
		 */
		public WrappingLabel getFigureDesligar_IntermitenciaLabelFigure() {
			return fFigureDesligar_IntermitenciaLabelFigure;
		}
	 ...
	 * @generated
	 */
	static final Color THIS_FORE = new Color(null, 255, 255, 64);
