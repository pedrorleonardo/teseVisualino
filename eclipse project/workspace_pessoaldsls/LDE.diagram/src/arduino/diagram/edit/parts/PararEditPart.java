...
import arduino.diagram.edit.policies.PararItemSemanticEditPolicy;
 ...
 * @generated
 */
public class PararEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public PararEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new PararItemSemanticEditPolicy());
	...
	protected IFigure createNodeShape() {
		return primaryShape = new PararFigure();
	}

	/**
	 * @generated
	 */
	public PararFigure getPrimaryShape() {
		return (PararFigure) primaryShape;
	}
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof PararNomeEditPart) {
			((PararNomeEditPart) childEditPart).setLabel(getPrimaryShape()
					.getFigurePararLabelFigure());
			return true;
		}
		return false;
	}
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(ArduinoVisualIDRegistry
				.getType(PararNomeEditPart.VISUAL_ID));
	}
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof arduino.diagram.edit.parts.PararEditPart) {
			types.add(ArduinoElementTypes.Transicoes_4001);
		}
	 ...
	 * @generated
	 */
	public class PararFigure extends Ellipse {

		/**
		 * @generated
		 */
		private WrappingLabel fFigurePararLabelFigure;
		...
		private void createContents() {
			...
			fFigurePararLabelFigure = new WrappingLabel();

			fFigurePararLabelFigure.setText("Parar");

			this.add(fFigurePararLabelFigure);
		 ...
		 * @generated
		 */
		public WrappingLabel getFigurePararLabelFigure() {
			return fFigurePararLabelFigure;
		}
