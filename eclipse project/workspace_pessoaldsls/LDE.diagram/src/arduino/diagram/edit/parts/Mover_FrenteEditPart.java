...
import arduino.diagram.edit.policies.Mover_FrenteItemSemanticEditPolicy;
 ...
 * @generated
 */
public class Mover_FrenteEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public Mover_FrenteEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new Mover_FrenteItemSemanticEditPolicy());
	...
	protected IFigure createNodeShape() {
		return primaryShape = new Mover_FrenteFigure();
	}

	/**
	 * @generated
	 */
	public Mover_FrenteFigure getPrimaryShape() {
		return (Mover_FrenteFigure) primaryShape;
	}
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof Mover_FrenteNomeEditPart) {
			((Mover_FrenteNomeEditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigureMover_FrenteLabelFigure());
			return true;
		}
		return false;
	}
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof arduino.diagram.edit.parts.Mover_FrenteEditPart) {
			types.add(ArduinoElementTypes.Transicoes_4001);
		}
	 ...
	 * @generated
	 */
	public class Mover_FrenteFigure extends Ellipse {

		/**
		 * @generated
		 */
		private WrappingLabel fFigureMover_FrenteLabelFigure;

		/**
		 * @generated
		 */
		public Mover_FrenteFigure() {
		...
		private void createContents() {
			...
			fFigureMover_FrenteLabelFigure = new WrappingLabel();

			fFigureMover_FrenteLabelFigure.setText("Mover_Frente");

			this.add(fFigureMover_FrenteLabelFigure);
		 ...
		 * @generated
		 */
		public WrappingLabel getFigureMover_FrenteLabelFigure() {
			return fFigureMover_FrenteLabelFigure;
		}
