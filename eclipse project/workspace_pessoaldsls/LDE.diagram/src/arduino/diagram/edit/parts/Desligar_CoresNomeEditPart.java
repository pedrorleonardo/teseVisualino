 ...
 * @generated
 */
public class Desligar_CoresNomeEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public Desligar_CoresNomeEditPart(View view) {
		super(view);
	}
			...
			parser = ArduinoParserProvider
					.getParser(
							...
							ArduinoVisualIDRegistry
									.getType(arduino.diagram.edit.parts.Desligar_CoresNomeEditPart.VISUAL_ID));
		}
		return parser;
	}
