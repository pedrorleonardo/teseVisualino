...
import arduino.diagram.edit.policies.Virar_EsquerdaItemSemanticEditPolicy;
 ...
 * @generated
 */
public class Virar_EsquerdaEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public Virar_EsquerdaEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new Virar_EsquerdaItemSemanticEditPolicy());
	...
	protected IFigure createNodeShape() {
		return primaryShape = new Virar_EsquerdaFigure();
	}

	/**
	 * @generated
	 */
	public Virar_EsquerdaFigure getPrimaryShape() {
		return (Virar_EsquerdaFigure) primaryShape;
	}
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof Virar_EsquerdaNomeEditPart) {
			((Virar_EsquerdaNomeEditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigureVirar_EsquerdaLabelFigure());
			return true;
		}
		return false;
	}
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof arduino.diagram.edit.parts.Virar_EsquerdaEditPart) {
			types.add(ArduinoElementTypes.Transicoes_4001);
		}
	 ...
	 * @generated
	 */
	public class Virar_EsquerdaFigure extends Ellipse {

		/**
		 * @generated
		 */
		private WrappingLabel fFigureVirar_EsquerdaLabelFigure;

		/**
		 * @generated
		 */
		public Virar_EsquerdaFigure() {
		...
		private void createContents() {
			...
			fFigureVirar_EsquerdaLabelFigure = new WrappingLabel();

			fFigureVirar_EsquerdaLabelFigure.setText("Virar_Esquerda");

			this.add(fFigureVirar_EsquerdaLabelFigure);
		 ...
		 * @generated
		 */
		public WrappingLabel getFigureVirar_EsquerdaLabelFigure() {
			return fFigureVirar_EsquerdaLabelFigure;
		}
