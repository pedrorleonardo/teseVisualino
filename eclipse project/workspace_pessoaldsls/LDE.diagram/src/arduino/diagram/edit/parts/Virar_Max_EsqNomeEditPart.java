 ...
 * @generated
 */
public class Virar_Max_EsqNomeEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public Virar_Max_EsqNomeEditPart(View view) {
		super(view);
	}
			...
			parser = ArduinoParserProvider
					.getParser(
							...
							ArduinoVisualIDRegistry
									.getType(arduino.diagram.edit.parts.Virar_Max_EsqNomeEditPart.VISUAL_ID));
		}
		return parser;
	}
