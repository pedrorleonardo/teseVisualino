...
import arduino.diagram.edit.policies.InicioItemSemanticEditPolicy;
...
public class InicioEditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new InicioItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof InicioNomeEditPart) {
			((InicioNomeEditPart) childEditPart).setLabel(getPrimaryShape()
					.getFigureInicioLabelFigure());
			return true;
		}
		return false;
	}
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(ArduinoVisualIDRegistry
				.getType(InicioNomeEditPart.VISUAL_ID));
	}
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof arduino.diagram.edit.parts.InicioEditPart) {
			types.add(ArduinoElementTypes.Transicoes_4001);
		}
	 ...
	 * @generated
	 */
	public class InicioFigure extends Ellipse {

		/**
		 * @generated
		 */
		private WrappingLabel fFigureInicioLabelFigure;
		...
		private void createContents() {
			...
			fFigureInicioLabelFigure = new WrappingLabel();

			fFigureInicioLabelFigure.setText("Inicio");

			this.add(fFigureInicioLabelFigure);
		 ...
		 * @generated
		 */
		public WrappingLabel getFigureInicioLabelFigure() {
			return fFigureInicioLabelFigure;
		}
