...
import arduino.diagram.edit.policies.Ligar_Cores_Arco_IrisItemSemanticEditPolicy;
 ...
 * @generated
 */
public class Ligar_Cores_Arco_IrisEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public Ligar_Cores_Arco_IrisEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new Ligar_Cores_Arco_IrisItemSemanticEditPolicy());
	...
	protected IFigure createNodeShape() {
		return primaryShape = new Ligar_Cores_Arco_IrisFigure();
	}

	/**
	 * @generated
	 */
	public Ligar_Cores_Arco_IrisFigure getPrimaryShape() {
		return (Ligar_Cores_Arco_IrisFigure) primaryShape;
	}
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof Ligar_Cores_Arco_IrisNomeEditPart) {
			((Ligar_Cores_Arco_IrisNomeEditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigureLigar_Cores_Arco_IrisLabelFigure());
			return true;
		}
		return false;
	}
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof arduino.diagram.edit.parts.Ligar_Cores_Arco_IrisEditPart) {
			types.add(ArduinoElementTypes.Transicoes_4001);
		}
	 ...
	 * @generated
	 */
	public class Ligar_Cores_Arco_IrisFigure extends Ellipse {

		/**
		 * @generated
		 */
		private WrappingLabel fFigureLigar_Cores_Arco_IrisLabelFigure;

		/**
		 * @generated
		 */
		public Ligar_Cores_Arco_IrisFigure() {
		...
		private void createContents() {
			...
			fFigureLigar_Cores_Arco_IrisLabelFigure = new WrappingLabel();

			fFigureLigar_Cores_Arco_IrisLabelFigure
					.setText("Ligar_Cores_Arco_Iris");

			this.add(fFigureLigar_Cores_Arco_IrisLabelFigure);
		 ...
		 * @generated
		 */
		public WrappingLabel getFigureLigar_Cores_Arco_IrisLabelFigure() {
			return fFigureLigar_Cores_Arco_IrisLabelFigure;
		}
