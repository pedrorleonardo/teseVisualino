 ...
 * @generated
 */
public class Virar_DireitaNomeEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public Virar_DireitaNomeEditPart(View view) {
		super(view);
	}
			...
			parser = ArduinoParserProvider
					.getParser(
							...
							ArduinoVisualIDRegistry
									.getType(arduino.diagram.edit.parts.Virar_DireitaNomeEditPart.VISUAL_ID));
		}
		return parser;
	}
