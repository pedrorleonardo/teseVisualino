...
import arduino.diagram.edit.policies.Mover_Frente_TempoItemSemanticEditPolicy;
 ...
 * @generated
 */
public class Mover_Frente_TempoEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public Mover_Frente_TempoEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new Mover_Frente_TempoItemSemanticEditPolicy());
	...
	protected IFigure createNodeShape() {
		return primaryShape = new Mover_Frente_TempoFigure();
	}

	/**
	 * @generated
	 */
	public Mover_Frente_TempoFigure getPrimaryShape() {
		return (Mover_Frente_TempoFigure) primaryShape;
	}
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof Mover_Frente_TempoTempoEditPart) {
			((Mover_Frente_TempoTempoEditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigureMover_Frente_TempoLabelFigure());
			return true;
		}
		return false;
	}
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof arduino.diagram.edit.parts.Mover_Frente_TempoEditPart) {
			types.add(ArduinoElementTypes.Transicoes_4001);
		}
	 ...
	 * @generated
	 */
	public class Mover_Frente_TempoFigure extends Ellipse {

		/**
		 * @generated
		 */
		private WrappingLabel fFigureMover_Frente_TempoLabelFigure;

		/**
		 * @generated
		 */
		public Mover_Frente_TempoFigure() {
		...
		private void createContents() {
			...
			fFigureMover_Frente_TempoLabelFigure = new WrappingLabel();

			fFigureMover_Frente_TempoLabelFigure.setText("Mover_Frente_Tempo");

			this.add(fFigureMover_Frente_TempoLabelFigure);
		 ...
		 * @generated
		 */
		public WrappingLabel getFigureMover_Frente_TempoLabelFigure() {
			return fFigureMover_Frente_TempoLabelFigure;
		}
