 ...
 * @generated
 */
public class Desligar_CorNomeEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public Desligar_CorNomeEditPart(View view) {
		super(view);
	}
			...
			parser = ArduinoParserProvider
					.getParser(
							...
							ArduinoVisualIDRegistry
									.getType(arduino.diagram.edit.parts.Desligar_CorNomeEditPart.VISUAL_ID));
		}
		return parser;
	}
