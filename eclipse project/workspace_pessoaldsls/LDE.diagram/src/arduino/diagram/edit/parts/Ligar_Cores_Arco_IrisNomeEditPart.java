 ...
 * @generated
 */
public class Ligar_Cores_Arco_IrisNomeEditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public Ligar_Cores_Arco_IrisNomeEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = ArduinoParserProvider
					.getParser(
							ArduinoElementTypes.Ligar_Cores_Arco_Iris_2002,
							getParserElement(),
							ArduinoVisualIDRegistry
									.getType(arduino.diagram.edit.parts.Ligar_Cores_Arco_IrisNomeEditPart.VISUAL_ID));
		}
		return parser;
	}
