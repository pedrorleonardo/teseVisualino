...
import arduino.diagram.edit.policies.Virar_45_EsqItemSemanticEditPolicy;
 ...
 * @generated
 */
public class Virar_45_EsqEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public Virar_45_EsqEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new Virar_45_EsqItemSemanticEditPolicy());
	...
	protected IFigure createNodeShape() {
		return primaryShape = new Virar_45_EsqFigure();
	}

	/**
	 * @generated
	 */
	public Virar_45_EsqFigure getPrimaryShape() {
		return (Virar_45_EsqFigure) primaryShape;
	}
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof Virar_45_EsqNomeEditPart) {
			((Virar_45_EsqNomeEditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigureVirar_45_EsqLabelFigure());
			return true;
		}
		return false;
	}
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof arduino.diagram.edit.parts.Virar_45_EsqEditPart) {
			types.add(ArduinoElementTypes.Transicoes_4001);
		}
	 ...
	 * @generated
	 */
	public class Virar_45_EsqFigure extends Ellipse {

		/**
		 * @generated
		 */
		private WrappingLabel fFigureVirar_45_EsqLabelFigure;

		/**
		 * @generated
		 */
		public Virar_45_EsqFigure() {
		...
		private void createContents() {
			...
			fFigureVirar_45_EsqLabelFigure = new WrappingLabel();

			fFigureVirar_45_EsqLabelFigure.setText("Virar_45_Esq");

			this.add(fFigureVirar_45_EsqLabelFigure);
		 ...
		 * @generated
		 */
		public WrappingLabel getFigureVirar_45_EsqLabelFigure() {
			return fFigureVirar_45_EsqLabelFigure;
		}
