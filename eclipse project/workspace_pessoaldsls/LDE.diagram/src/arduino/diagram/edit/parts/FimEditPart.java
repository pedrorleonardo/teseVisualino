...
import arduino.diagram.edit.policies.FimItemSemanticEditPolicy;
 ...
 * @generated
 */
public class FimEditPart extends ShapeNodeEditPart {
	...
	protected IFigure createNodeShape() {
		return primaryShape = new FimFigure();
	}

	/**
	 * @generated
	 */
	public FimFigure getPrimaryShape() {
		return (FimFigure) primaryShape;
	}
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof FimNomeEditPart) {
			((FimNomeEditPart) childEditPart).setLabel(getPrimaryShape()
					.getFigureFimLabelFigure());
			return true;
		}
		return false;
	}
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(ArduinoVisualIDRegistry
				.getType(FimNomeEditPart.VISUAL_ID));
	}
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof arduino.diagram.edit.parts.FimEditPart) {
			types.add(ArduinoElementTypes.Transicoes_4001);
		}
		return types;
	}
	 ...
	 * @generated
	 */
	public class FimFigure extends Ellipse {

		/**
		 * @generated
		 */
		private WrappingLabel fFigureFimLabelFigure;
		...
		private void createContents() {
			...
			fFigureFimLabelFigure = new WrappingLabel();

			fFigureFimLabelFigure.setText("Fim");

			this.add(fFigureFimLabelFigure);
		 ...
		 * @generated
		 */
		public WrappingLabel getFigureFimLabelFigure() {
			return fFigureFimLabelFigure;
		}
