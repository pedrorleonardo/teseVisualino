...
import arduino.diagram.edit.policies.IfItemSemanticEditPolicy;
...
public class IfEditPart extends ShapeNodeEditPart {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof IfNomeEditPart) {
			((IfNomeEditPart) childEditPart).setLabel(getPrimaryShape()
					.getFigureIfLabelFigure());
			return true;
		}
		return false;
	}
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(ArduinoVisualIDRegistry
				.getType(IfNomeEditPart.VISUAL_ID));
	}
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof arduino.diagram.edit.parts.IfEditPart) {
			types.add(ArduinoElementTypes.Transicoes_4001);
		}
	 ...
	 * @generated
	 */
	public class IfFigure extends Ellipse {
