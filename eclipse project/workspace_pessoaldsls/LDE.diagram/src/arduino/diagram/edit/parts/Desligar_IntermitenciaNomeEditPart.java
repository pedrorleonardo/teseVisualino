...
import arduino.diagram.edit.policies.ArduinoTextSelectionEditPolicy;
 ...
 * @generated
 */
public class Desligar_IntermitenciaNomeEditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public Desligar_IntermitenciaNomeEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE,
				new ArduinoTextSelectionEditPolicy());
		installEditPolicy(EditPolicy.DIRECT_EDIT_ROLE,
				new LabelDirectEditPolicy());
		installEditPolicy(EditPolicy.PRIMARY_DRAG_ROLE,
				new RoboEditPart.NodeLabelDragPolicy());
	}
	...
	protected Image getLabelIcon() {
		...
		return ArduinoElementTypes.getImage(parserElement.eClass());
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = ArduinoParserProvider
					.getParser(
							ArduinoElementTypes.Desligar_Intermitencia_2011,
							getParserElement(),
							ArduinoVisualIDRegistry
									.getType(arduino.diagram.edit.parts.Desligar_IntermitenciaNomeEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager2(this, null,
					ArduinoEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
