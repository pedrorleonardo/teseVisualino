 ...
 * @generated
 */
public class Virar_EsquerdaNomeNomeEditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public Virar_EsquerdaNomeNomeEditPart(View view) {
		super(view);
	}
			...
			parser = ArduinoParserProvider
					.getParser(
							...
							ArduinoVisualIDRegistry
									.getType(arduino.diagram.edit.parts.Virar_EsquerdaNomeNomeEditPart.VISUAL_ID));
		}
		return parser;
	}
