...
import arduino.diagram.edit.policies.Mover_TrasItemSemanticEditPolicy;
 ...
 * @generated
 */
public class Mover_TrasEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public Mover_TrasEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new Mover_TrasItemSemanticEditPolicy());
	...
	protected IFigure createNodeShape() {
		return primaryShape = new Mover_TrasFigure();
	}

	/**
	 * @generated
	 */
	public Mover_TrasFigure getPrimaryShape() {
		return (Mover_TrasFigure) primaryShape;
	}
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof Mover_TrasNomeEditPart) {
			((Mover_TrasNomeEditPart) childEditPart).setLabel(getPrimaryShape()
					.getFigureMover_TrasLabelFigure());
			return true;
		}
		return false;
	}
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof arduino.diagram.edit.parts.Mover_TrasEditPart) {
			types.add(ArduinoElementTypes.Transicoes_4001);
		}
	 ...
	 * @generated
	 */
	public class Mover_TrasFigure extends Ellipse {

		/**
		 * @generated
		 */
		private WrappingLabel fFigureMover_TrasLabelFigure;

		/**
		 * @generated
		 */
		public Mover_TrasFigure() {
		...
		private void createContents() {
			...
			fFigureMover_TrasLabelFigure = new WrappingLabel();

			fFigureMover_TrasLabelFigure.setText("Mover_Tras");

			this.add(fFigureMover_TrasLabelFigure);
		 ...
		 * @generated
		 */
		public WrappingLabel getFigureMover_TrasLabelFigure() {
			return fFigureMover_TrasLabelFigure;
		}
