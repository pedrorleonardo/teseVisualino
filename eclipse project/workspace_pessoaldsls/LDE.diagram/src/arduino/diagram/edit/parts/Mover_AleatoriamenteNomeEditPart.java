 ...
 * @generated
 */
public class Mover_AleatoriamenteNomeEditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public Mover_AleatoriamenteNomeEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = ArduinoParserProvider
					.getParser(
							ArduinoElementTypes.Mover_Aleatoriamente_2026,
							getParserElement(),
							ArduinoVisualIDRegistry
									.getType(arduino.diagram.edit.parts.Mover_AleatoriamenteNomeEditPart.VISUAL_ID));
		}
		return parser;
	}
