...
import arduino.diagram.edit.policies.Ligar_VerdeItemSemanticEditPolicy;
 ...
 * @generated
 */
public class Ligar_VerdeEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public Ligar_VerdeEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new Ligar_VerdeItemSemanticEditPolicy());
	...
	protected IFigure createNodeShape() {
		return primaryShape = new Ligar_VerdeFigure();
	}

	/**
	 * @generated
	 */
	public Ligar_VerdeFigure getPrimaryShape() {
		return (Ligar_VerdeFigure) primaryShape;
	}
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof Ligar_VerdeNomeEditPart) {
			((Ligar_VerdeNomeEditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigureLigar_VerdeLabelFigure());
			return true;
		}
		return false;
	}
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof arduino.diagram.edit.parts.Ligar_VerdeEditPart) {
			types.add(ArduinoElementTypes.Transicoes_4001);
		}
	 ...
	 * @generated
	 */
	public class Ligar_VerdeFigure extends Ellipse {

		/**
		 * @generated
		 */
		private WrappingLabel fFigureLigar_VerdeLabelFigure;

		/**
		 * @generated
		 */
		public Ligar_VerdeFigure() {
		...
		private void createContents() {
			...
			fFigureLigar_VerdeLabelFigure = new WrappingLabel();

			fFigureLigar_VerdeLabelFigure.setText("Ligar_Verde");

			this.add(fFigureLigar_VerdeLabelFigure);
		 ...
		 * @generated
		 */
		public WrappingLabel getFigureLigar_VerdeLabelFigure() {
			return fFigureLigar_VerdeLabelFigure;
		}
