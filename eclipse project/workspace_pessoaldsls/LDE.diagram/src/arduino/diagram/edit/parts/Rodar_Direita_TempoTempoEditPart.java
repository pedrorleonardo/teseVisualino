 ...
 * @generated
 */
public class Rodar_Direita_TempoTempoEditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public Rodar_Direita_TempoTempoEditPart(View view) {
		super(view);
	}
			...
			parser = ArduinoParserProvider
					.getParser(
							...
							ArduinoVisualIDRegistry
									.getType(arduino.diagram.edit.parts.Rodar_Direita_TempoTempoEditPart.VISUAL_ID));
		}
		return parser;
	}
