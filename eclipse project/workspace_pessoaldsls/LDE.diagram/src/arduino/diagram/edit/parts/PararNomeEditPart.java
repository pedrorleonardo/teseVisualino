 ...
 * @generated
 */
public class PararNomeEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public PararNomeEditPart(View view) {
		super(view);
	}
			...
			parser = ArduinoParserProvider
					.getParser(
							...
							ArduinoVisualIDRegistry
									.getType(arduino.diagram.edit.parts.PararNomeEditPart.VISUAL_ID));
		}
		return parser;
	}
