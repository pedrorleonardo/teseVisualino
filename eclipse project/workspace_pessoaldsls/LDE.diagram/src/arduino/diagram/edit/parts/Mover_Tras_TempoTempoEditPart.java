 ...
 * @generated
 */
public class Mover_Tras_TempoTempoEditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public Mover_Tras_TempoTempoEditPart(View view) {
		super(view);
	}
			...
			parser = ArduinoParserProvider
					.getParser(
							...
							ArduinoVisualIDRegistry
									.getType(arduino.diagram.edit.parts.Mover_Tras_TempoTempoEditPart.VISUAL_ID));
		}
		return parser;
	}
