...
import arduino.diagram.edit.policies.Ligar_Cores_PoliciaItemSemanticEditPolicy;
 ...
 * @generated
 */
public class Ligar_Cores_PoliciaEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public Ligar_Cores_PoliciaEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new Ligar_Cores_PoliciaItemSemanticEditPolicy());
	...
	protected IFigure createNodeShape() {
		return primaryShape = new Ligar_Cores_PoliciaFigure();
	}

	/**
	 * @generated
	 */
	public Ligar_Cores_PoliciaFigure getPrimaryShape() {
		return (Ligar_Cores_PoliciaFigure) primaryShape;
	}
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof Ligar_Cores_PoliciaNomeEditPart) {
			((Ligar_Cores_PoliciaNomeEditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigureLigar_Cores_PoliciaLabelFigure());
			return true;
		}
		return false;
	}
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof arduino.diagram.edit.parts.Ligar_Cores_PoliciaEditPart) {
			types.add(ArduinoElementTypes.Transicoes_4001);
		}
	 ...
	 * @generated
	 */
	public class Ligar_Cores_PoliciaFigure extends Ellipse {

		/**
		 * @generated
		 */
		private WrappingLabel fFigureLigar_Cores_PoliciaLabelFigure;

		/**
		 * @generated
		 */
		public Ligar_Cores_PoliciaFigure() {
		...
		private void createContents() {
			...
			fFigureLigar_Cores_PoliciaLabelFigure = new WrappingLabel();

			fFigureLigar_Cores_PoliciaLabelFigure
					.setText("Ligar_Cores_Policia");

			this.add(fFigureLigar_Cores_PoliciaLabelFigure);
		 ...
		 * @generated
		 */
		public WrappingLabel getFigureLigar_Cores_PoliciaLabelFigure() {
			return fFigureLigar_Cores_PoliciaLabelFigure;
		}
