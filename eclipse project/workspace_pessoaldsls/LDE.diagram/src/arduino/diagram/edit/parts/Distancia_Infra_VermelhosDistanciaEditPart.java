 ...
 * @generated
 */
public class Distancia_Infra_VermelhosDistanciaEditPart extends
	 ...
	 * @generated
	 */
	public Distancia_Infra_VermelhosDistanciaEditPart(View view) {
		super(view);
	}
			...
			parser = ArduinoParserProvider
					.getParser(
							...
							ArduinoVisualIDRegistry
									.getType(arduino.diagram.edit.parts.Distancia_Infra_VermelhosDistanciaEditPart.VISUAL_ID));
		}
		return parser;
	}
