 ...
 * @generated
 */
public class Virar_Max_DrtNomeEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public Virar_Max_DrtNomeEditPart(View view) {
		super(view);
	}
			...
			parser = ArduinoParserProvider
					.getParser(
							...
							ArduinoVisualIDRegistry
									.getType(arduino.diagram.edit.parts.Virar_Max_DrtNomeEditPart.VISUAL_ID));
		}
		return parser;
	}
