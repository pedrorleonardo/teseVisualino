...
import arduino.diagram.edit.policies.Desligar_CorItemSemanticEditPolicy;
 ...
 * @generated
 */
public class Desligar_CorEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public Desligar_CorEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new Desligar_CorItemSemanticEditPolicy());
	...
	protected IFigure createNodeShape() {
		return primaryShape = new Desligar_CorFigure();
	}

	/**
	 * @generated
	 */
	public Desligar_CorFigure getPrimaryShape() {
		return (Desligar_CorFigure) primaryShape;
	}
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof Desligar_CorNomeEditPart) {
			((Desligar_CorNomeEditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigureDesligar_CorLabelFigure());
			return true;
		}
		return false;
	}
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof arduino.diagram.edit.parts.Desligar_CorEditPart) {
			types.add(ArduinoElementTypes.Transicoes_4001);
		}
	 ...
	 * @generated
	 */
	public class Desligar_CorFigure extends Ellipse {

		/**
		 * @generated
		 */
		private WrappingLabel fFigureDesligar_CorLabelFigure;

		/**
		 * @generated
		 */
		public Desligar_CorFigure() {
		...
		private void createContents() {
			...
			fFigureDesligar_CorLabelFigure = new WrappingLabel();

			fFigureDesligar_CorLabelFigure.setText("Desligar_Cor");

			this.add(fFigureDesligar_CorLabelFigure);
		 ...
		 * @generated
		 */
		public WrappingLabel getFigureDesligar_CorLabelFigure() {
			return fFigureDesligar_CorLabelFigure;
		}
