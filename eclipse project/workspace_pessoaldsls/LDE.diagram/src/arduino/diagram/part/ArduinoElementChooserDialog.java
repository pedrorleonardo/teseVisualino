 ...
 * @generated
 */
public class ArduinoElementChooserDialog extends Dialog {
	 ...
	 * @generated
	 */
	public ArduinoElementChooserDialog(Shell parentShell, View view) {
		super(parentShell);
	...
	protected Control createDialogArea(Composite parent) {
		...
		getShell().setText(
				Messages.ArduinoElementChooserDialog_SelectModelElementTitle);
	...
	private boolean isValidModelFile(IFile file) {
		...
		return "arduino".equals(fileExtension); //$NON-NLS-1$
	}
