 ...
 * @generated
 */
public class ArduinoInitDiagramFileAction implements IObjectActionDelegate {
	...
	public void run(IAction action) {
		...
		Wizard wizard = new ArduinoNewDiagramFileWizard(domainModelURI,
				diagramRoot, editingDomain);
		wizard.setWindowTitle(NLS.bind(Messages.InitDiagramFile_WizardTitle,
				RoboEditPart.MODEL_ID));
		ArduinoDiagramEditorUtil.runWizard(getShell(), wizard,
