 ...
 * @generated
 */
public class ArduinoDomainNavigatorContentProvider implements
	 ...
	 * @generated
	 */
	public ArduinoDomainNavigatorContentProvider() {
	...
	public Object[] getChildren(Object parentElement) {
		...
		if (parentElement instanceof ArduinoDomainNavigatorItem) {
			return wrapEObjects(
					myAdapterFctoryContentProvier.getChildren(((ArduinoDomainNavigatorItem) parentElement)
	...
	public Object[] wrapEObjects(Object[] objects, Object parentElement) {
		...
		for (int i = 0; i < objects.length; i++) {
			if (objects[i] instanceof EObject) {
				result.add(new ArduinoDomainNavigatorItem((EObject) objects[i],
