...
public class IfItemProvider
  extends Acoes_CondicionaisItemProvider
  implements
    ...
    IItemPropertySource
{
    ...
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         getResourceLocator(),
         getString("_UI_If_nome_feature"),
         getString("_UI_PropertyDescriptor_description", "_UI_If_nome_feature", "_UI_If_type"),
         ArduinoPackage.Literals.IF__NOME,
         true,
         false,
         false,
    ...
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         ...
         ArduinoPackage.Literals.IF__THEN,
         true,
         false,
         true,
         null,
  ...
  {
    String label = ((If)object).getNome();
