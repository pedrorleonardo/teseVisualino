...
/**
 * This is the item provider adapter for a {@link arduino.Inicio} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
    ...
    IItemPropertySource
{
    ...
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         getResourceLocator(),
         getString("_UI_Inicio_nome_feature"),
         getString("_UI_PropertyDescriptor_description", "_UI_Inicio_nome_feature", "_UI_Inicio_type"),
         ArduinoPackage.Literals.INICIO__NOME,
         true,
         false,
         false,
  ...
  protected void addEvitarObstaculoPropertyDescriptor(Object object)
  {
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         getResourceLocator(),
         getString("_UI_Inicio_evitarObstaculo_feature"),
         getString("_UI_PropertyDescriptor_description", "_UI_Inicio_evitarObstaculo_feature", "_UI_Inicio_type"),
         ArduinoPackage.Literals.INICIO__EVITAR_OBSTACULO,
         true,
         false,
         false,
  ...
  {
    String label = ((Inicio)object).getNome();
