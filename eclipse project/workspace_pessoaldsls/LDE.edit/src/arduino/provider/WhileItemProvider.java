    ...
    IItemPropertySource
{
  ...
  public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object)
  {
    if (itemPropertyDescriptors == null)
    {
      ...
      addCorpoPropertyDescriptor(object);
    }
    ...
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         getResourceLocator(),
         getString("_UI_While_nome_feature"),
         getString("_UI_PropertyDescriptor_description", "_UI_While_nome_feature", "_UI_While_type"),
         ArduinoPackage.Literals.WHILE__NOME,
         true,
         false,
         false,
  ...
  /**
   * This adds a property descriptor for the Corpo feature.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   */
  protected void addCorpoPropertyDescriptor(Object object)
  {
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         getResourceLocator(),
         getString("_UI_While_corpo_feature"),
         getString("_UI_PropertyDescriptor_description", "_UI_While_corpo_feature", "_UI_While_type"),
         ArduinoPackage.Literals.WHILE__CORPO,
         true,
         false,
         true,
         null,
  ...
  {
    String label = ((While)object).getNome();
